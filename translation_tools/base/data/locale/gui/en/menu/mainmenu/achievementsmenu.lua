...
descsurf = "Stand on a plank floating on a single airflow for four seconds"
deschazard = "Make goblins die of three different environmental hazards in a single level"
descsolo = "Complete a whole level playing one character only"
desccarni = "Feed carnivorous plants with three or more different kinds of treats"
descshatter = "Shatter three frozen enemies within one second"
deschammer = "Kill an enemy with a thrown hammer bouncing at least once before kill"
descfriendly_fire = "Get at least 10 enemies killed by other enemies' actions in a single level"
descbounce = "Stand on a conjured box bouncing on any bouncy surface for 10 seconds"
descarrow = "Shoot three arrows in the air and catch them all with the Knight's shield"
desctower = "Construct a tower made of eight objects and stand on top of it"
descrope = "Using grapple, swing around an object and reattach grapple again without touching any surface"
descbubble = "Make a bubble sink for three seconds"
descplatinum = "Earn all Achievements in Trine"
