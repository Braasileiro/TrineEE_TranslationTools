...
all_languages = 
{
	...
	, { id = "pt", nativeName = "Português", englishName = "Portuguese", audioName = "english_us_/" } -- Or choose any audioName above
}
...
function initLanguagesPerPlatformOrBuild()
	...
	if platformModule:isPlatformWindows() or platformModule:isPlatformOSX() or platformModule:isPlatformLinux() then
		if FB_BUILD == "FB_FINAL_RELEASE" then
			...
			tmplanguages =					{"en", "de", "fr", "es", "it", "pt"}
			tmpguiLocaleLanguages =			{"en", "de", "fr", "es", "it", "pt"}
			tmpsubtitleLocaleLanguages =	{"en", "de", "fr", "es", "it", "pt"}
